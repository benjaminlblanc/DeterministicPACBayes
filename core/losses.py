...
def bin_loss(y_target, y_pred, theta, distribution, classif_type, n=100):
...
def moment_loss(y_target, y_pred, theta, distribution, n_classes, order=1):
    ...
    if distribution == 'dirichlet':
        ...
        if n_classes == 2:
            ...
            return multinomial_cdf_precomputations(y_pred, y_target, theta, n_classes, torch.tensor(order))
